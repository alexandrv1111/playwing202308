...
revenue_details_df = pd.read_excel(pw_excel, sheet_name='revenue_details')
active_servers_df = pd.read_excel(pw_excel, sheet_name='active_servers')
...
revenue_of_active_servers = revenue_of_all_servers.loc[revenue_of_all_servers.Server.isin(active_servers_df.Server)]
